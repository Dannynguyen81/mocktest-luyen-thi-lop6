...
// Structure: Q1-Q6 Science, Q7-Q11 Hist/Geo/Knowledge, Q12-Q13 English, Q14-Q17 Math/Logic, Q18-Q20 Vietnamese.
        ...
        questions: [
          {
            ...
            options: ["A. Petals","B. Anthers","C. Ovary","D. Stigma"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Because it causes a fire due to the combination of water and electricity.","B. Because it damages the electrical system as water affects the proper current of electricity.","C. Because it causes an electric shock as water allows electricity to run through it.","D. Because it causes the plug to malfunction as water prevents the current of electricity."],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. a predator","B. a prey","C. a herbivore","D. a producer"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Bulb in Picture 1","B. Bulb in Picture 2","C. Bulb in Picture 3","D. Bulb in Picture 4"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Nhà Rồng wharf","B. Bùi Viện walking street","C. Nguyễn Huệ walking street","D. Bạch Đằng wharf"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Đại Việt","B. Âu Lạc","C. Đại Cồ Việt","D. Văn Lang"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. Fire","B. The sun","C. Geothermal heat","D. Wind"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Insects and worms","B. Rocks and stones","C. Fish and meat","D. Grass and leaves"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. 11.7 million people","B. 23.6 million people","C. 11.9 million people","D. 21.6 million people"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. The Sài Gòn river","B. The Nho Quế river","C. The Thu Bồn river","D. The Mê Công river"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. We are brother and sister. Say hello to us.","B. Holding hands is good. Do it now, please.","C. Kids often cross this road. Please slow down.","D. The road is slippery. Take care of your kids."],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. playing","B. plays","C. to play","D. played"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. sea","B. hill","C. river","D. brook"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Picture 1","B. Picture 2","C. Picture 3","D. Picture 4"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. 190","B. 234","C. 242","D. 244"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. ẩm","B. cao","C. ráo","D. nhỏ"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Trời càng nắng gắt, hoa giấy càng bồng lên rực rỡ.","B. Vì tôi đi xa nhưng tôi luôn nhớ đến mảnh đất yêu thương này.","C. Giá mà bạn đưa thêm hình ảnh vào thì bài thuyết trình đã hay hơn.","D. Chúng tôi nói đến đâu, anh ấy hiểu đến đó."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Đọc nhiều quyển sách thật nhanh để tiếp thu kiến thức nhiều nhất có thể.","B. Đọc sách không chỉ là việc của cá nhân mà đó còn là việc của toàn nhân loại.","C. Đọc sách không cần phải đọc thật kĩ, chủ yếu phải lướt cho nhanh, đọc cho nhiều.","D. Đọc sách không cốt lấy nhiều, quan trọng nhất là phải chọn cho tinh, đọc cho kĩ."],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
        ...
        questions: [
          {
            ...
            options: ["A. Aluminium is not corroded.","B. Aluminium conducts electricity better than copper.","C. Aluminium is lighter than copper.","D. Aluminium is more expensive than copper."],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Use the magnet → create the solution from water → evaporate → filter","B. Filter → use the magnet → create the solution from water → evaporate","C. Evaporate → use the magnet → create the solution from water → filter","D. Use the magnet → create the solution from water → filter → evaporate"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. Bandage the bleeding injury without medical gloves","B. Play with used injection needles","C. Talk and console patients infected with HIV/AIDS","D. Have an intravenous infusion without the legal source"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Eat fresh fruits instead of drinking fruit juice","B. Drink 100% pure fruit juice","C. Drink fruit juice containing lots of sugar","D. Eat lots of meat and less vegetables"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. wax","B. coal","C. biogas","D. petrol"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. The Việt Bắc victory","B. The Biên giới victory","C. The Điện Biên Phủ victory","D. The Vạn Tường victory"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Thủ Thiêm bridge","B. Rạch Chiếc bridge","C. Bình Lợi bridge","D. Bình Triệu bridge"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Tropical zone","B. Temperate zone","C. Frigid zone","D. Monsoon climate zone"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Đồng Nai river","B. Sông Bé river","C. Sài Gòn river","D. Mê Công river"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            maxPoints: 2.0,
            text: "Question 11. What does the sign on the right say?",
            options: ["A. This route is forbidden to everyone.","B. Cyclists are not allowed to enter this route.","C. Cyclists should not go fast at night.","D. Cycle route is ahead."],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. the easiest","B. so easy","C. easy","D. much easier"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            maxPoints: 2.0,
            text: "Question 13. Choose the word that does not belong with the other ones.",
            options: ["A. teacher","B. cooker","C. engineer","D. reporter"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Piece A","B. Piece B","C. Piece C","D. Piece D"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. 90 minutes","B. 4 hours","C. 45 minutes","D. 3 hours"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. 1099 cm2","B. 1256 cm2","C. 1344 cm2","D. 1570 cm2"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Là phương tiện cao cấp, hiện đại dùng để làm việc.","B. Là dụng cụ cao cấp, hiện đại dùng để mở, đóng cửa.","C. Là phương thức, mấu chốt quan trọng để giải quyết công việc.","D. Là công cụ bằng kim loại dùng tra vào ổ khoá để mở, đóng cửa."],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Những con người ấy","B. Những người sống tốt","C. Những người cống hiến","D. Những người lo nghĩ"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Hãy sống thật vui vẻ và lạc quan.","B. Hãy sống bao dung với mọi người.","C. Hãy sống thật hạnh phúc và bình yên.","D. Hãy sống hết mình với mọi người."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
        ...
        questions: [
          {
            ...
            options: ["A. Cut down trees and deforest","B. Raise wild animals as pets","C. Plant trees, protect and take care of animals","D. Tease animals when visiting the zoo"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Heat up iron nails before using","B. Clean and dry iron nails after using","C. Soak iron nails into salt water","D. Paint or apply oil to iron nails"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. Use a magnifying glass to look at the sheet of paper","B. Soak the sheet of paper into cold water","C. Heat up the sheet of paper","D. Soak the sheet of paper into warm water"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. rise from tube A","B. rise from tube B","C. rise from both tube A and tube B","D. not rise from any tubes"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Tuna increases, sea tiny shrimp decreases, seaweed increases.","B. Tuna decreases, sea tiny shrimp increases, seaweed increases.","C. Tuna increases, sea tiny shrimp decreases, seaweed decreases.","D. Tuna decreases, sea tiny shrimp increases, seaweed decreases."],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. Lactic bacteria change sugar in the condensed milk into organic acids.","B. Lactic bacteria change protein in the condensed milk into organic acids.","C. Lactic bacteria change lipid in the condensed milk into organic acids.","D. Lactic bacteria change available substances in the condensed milk into Vitamin C."],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. The Declaration of Independence of President Hồ Chí Minh on September 2nd, 1945","B. The victory of the Điện Biên Phủ campaign on May 7th, 1954","C. The Liberation of Tây Nguyên on March 24th, 1975","D. The complete victory of Hồ Chí Minh campaign on April 30th, 1975"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. Bến xe Suối Tiên station","B. Ba Son station","C. Thảo Điền station","D. Thủ Đức station"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Võ Nguyên Giáp","B. Mai Chí Thọ","C. Văn Tiến Dũng","D. Nguyễn Chí Thanh"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Construct tall buildings, build reserve lakes","B. Sort out, reuse and recycle household waste","C. Build reserve lakes, reduce green space density","D. Pave all sidewalks with granite"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. People mustn’t get access to wild animals’ cages.","B. People mustn’t give food to wild animals to avoid their dangerous reactions.","C. People should feed wild animals as it can please them.","D. People must give food to wild animals because they are in the cages."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. has developed","B. developed","C. develops","D. was developing"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            maxPoints: 2.0,
            text: "Question 13. Choose the word that does not belong with the other ones:",
            options: ["A. cliff","B. valley","C. dune","D. scene"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. Star","B. Square","C. Circle","D. Diamond"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. 24 cm","B. 28 cm","C. 34 cm","D. 40 cm"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. 66,66%","B. 80%","C. 60%","D. 70%"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Đánh dấu các ý trong một đoạn liệt kê.","B. Đánh dấu bộ phận chú thích, giải thích trong câu.","C. Nối các từ ngữ trong một liên danh.","D. Đánh dấu lời nói trực tiếp của nhân vật."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. trong trẻo","B. trong lành","C. trong vắt","D. trong trắng"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Tái hiện những trang sử vẻ vang của dân tộc Việt Nam thời kì dựng nước và giữ nước.","B. Yêu mến, tự hào về vẻ đẹp của đất nước và con người Việt Nam kiên cường, bất khuất.","C. Trân trọng sự tài hoa và những giá trị văn hoá truyền thống của dân tộc Việt Nam.","D. Khẳng định vẻ đẹp thiên nhiên trù phú, thơ mộng, trữ tình trên mọi miền đất nước."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
        ...
        questions: [
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 1. What state of matter has a definite volume but no definite shape?",
            options: ["A. Solid","B. Liquid","C. Gas","D. Plasma"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Chất lỏng (Liquid) có thể tích xác định nhưng không có hình dạng xác định (nó có hình dạng của vật chứa nó)."
          },
          {
            id: "TN4_2",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 2. Which of the following is a producer in a food chain?",
            options: ["A. Green plant","B. Grasshopper","C. Frog","D. Snake"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Thực vật màu xanh (Green plant) là sinh vật sản xuất (producer) vì chúng tự tổng hợp chất dinh dưỡng nhờ quang hợp."
          },
          {
            id: "TN4_3",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 3. Why are handles of cooking pans usually made of plastic or wood?",
            options: ["A. Because plastic and wood are good conductors of electricity.","B. Because plastic and wood make the pans look more beautiful.","C. Because plastic and wood are poor conductors of heat (insulators).","D. Because plastic and wood can withstand extremely high temperatures without burning."],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Nhựa và gỗ là chất dẫn nhiệt kém (insulators), giúp người nấu ăn không bị bỏng tay khi cầm vào quai/cán chảo."
          },
          {
            id: "TN4_4",
            type: "mc",
            ...
            options: ["A. Battery","B. Switch","C. Bulb","D. Wire"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Công tắc (Switch) là thiết bị dùng để đóng hoặc ngắt mạch điện, điều khiển thiết bị điện hoạt động."
          },
          {
            id: "TN4_5",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 5. Which gas do plants release into the air during photosynthesis?",
            options: ["A. Oxygen","B. Carbon dioxide","C. Nitrogen","D. Hydrogen"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Trong quá trình quang hợp, thực vật hấp thụ khí cacbônic và nước để tạo ra tinh bột đồng thời giải phóng khí ôxy (Oxygen) vào không khí."
          },
          {
            id: "TN4_6",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 6. What force pulls objects toward the center of the Earth?",
            options: ["A. Friction","B. Gravity","C. Magnetism","D. Tension"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Trọng lực (Gravity) là lực hút của Trái Đất tác dụng lên các vật, kéo chúng về phía tâm Trái Đất."
          },
          {
            id: "TN4_7",
            type: "mc",
            ...
            options: ["A. Nha Trang","B. Vũng Tàu","C. Đà Lạt","D. Sa Pa"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Thành phố Đà Lạt (Lâm Đồng) nổi tiếng với khí hậu mát mẻ quanh năm và ngàn hoa khoe sắc nên được gọi là 'Thành phố Ngàn hoa'."
          },
          {
            id: "TN4_8",
            type: "mc",
            ...
            options: ["A. Đinh Bộ Lĩnh","B. Ngô Quyền","C. Trần Hưng Đạo","D. Lê Lợi"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Năm 938, Ngô Quyền chỉ huy quân dân ta đóng cọc gỗ đầu bịt sắt trên sông Bạch Đằng, đánh tan quân Nam Hán, mở ra kỷ nguyên độc lập lâu dài."
          },
          {
            id: "TN4_9",
            type: "mc",
            ...
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Thủ đô của nước Pháp là Paris, trung tâm văn hóa và kinh tế nổi tiếng thế giới."
          },
          {
            id: "TN4_10",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 10. Which famous lighthouse built in 1862 on the top of Nhỏ Mountain is one of the oldest lighthouses in Vietnam and Southeast Asia?",
            options: ["A. Vũng Tàu Lighthouse","B. Kê Gà Lighthouse","C. Đại Lãnh Lighthouse","D. Song Tử Tây Lighthouse"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Hải đăng Vũng Tàu được người Pháp xây dựng năm 1862 trên đỉnh núi Nhỏ (núi Tao Phùng) để báo hiệu cho tàu thuyền, là một trong những ngọn hải đăng cổ xưa nhất Việt Nam."
          },
          {
            id: "TN4_11",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 11. What is the longest river in the world?",
            options: ["A. Amazon River","B. Yangtze River","C. Nile River","D. Mississippi River"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Sông Nin (Nile River) ở châu Phi là con sông dài nhất thế giới (khoảng 6,650 km), chảy qua nhiều quốc gia."
          },
          {
            id: "TN4_12",
            type: "mc",
          ...
          },
          {
            ...
            options: ["A. rain","B. rained","C. rains","D. will rain"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. 7200","B. 8400","C. 8600","D. 8640"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. 108","B. 120","C. 96","D. 132"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. 314 cm2","B. 400 cm2","C. 628 cm2","D. 200 cm2"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Ồn ào","B. Nhộn nhịp","C. Hòa bình","D. Khẩn trương"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Nếu... thì...","B. Vì... nên...","C. Tuy... nhưng...","D. Nhờ... mà..."],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Nhân hóa","B. So sánh","C. Điệp ngữ","D. Nói quá"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
        ...
        questions: [
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 1. Water exists in three states. What are they?",
            options: ["A. Ice, liquid water, steam","B. Salt water, fresh water, rain","C. Ocean, river, lake","D. Oxygen, hydrogen, carbon dioxide"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Ba trạng thái của nước bao gồm: thể rắn (Ice/băng đá), thể lỏng (Liquid water/nước) và thể khí (Steam/hơi nước)."
          },
          {
            id: "TN5_2",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 2. What is the primary source of energy for the water cycle on Earth?",
            options: ["A. Geothermal heat","B. The sun","C. Wind","D. Oceans"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Mặt trời (The sun) cung cấp năng lượng nhiệt làm bốc hơi nước từ sông, biển lên không trung, khởi động chu trình tuần hoàn nước."
          },
          {
            id: "TN5_3",
            type: "mc",
            ...
            options: ["A. Iron","B. Gold","C. Copper","D. Lead"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Đồng (Copper) là kim loại có khả năng dẫn điện rất tốt, dẻo dễ uốn và giá thành hợp lý nên được dùng làm lõi dây điện gia đình."
          },
          {
            id: "TN5_4",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 4. Air is a mixture of gases. Which gas is the most abundant in Earth's atmosphere?",
            options: ["A. Oxygen","B. Nitrogen","C. Carbon dioxide","D. Argon"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Khí nitơ (Nitrogen) chiếm khoảng 78% thể tích không khí, là chất khí dồi dào nhất trong khí quyển Trái Đất (ôxy chiếm khoảng 21%)."
          },
          {
            id: "TN5_5",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 5. What type of energy is stored in a battery?",
            options: ["A. Kinetic energy","B. Thermal energy","C. Chemical energy","D. Light energy"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Pin tích lũy năng lượng dưới dạng hóa năng (Chemical energy). Khi kết nối vào mạch, phản ứng hóa học xảy ra giải phóng điện năng."
          },
          {
            id: "TN5_6",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 6. In which process do green plants absorb sunlight to make glucose and release oxygen?",
            options: ["A. Respiration","B. Photosynthesis","C. Transpiration","D. Fermentation"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Quang hợp (Photosynthesis) là quá trình lá cây hấp thụ ánh sáng mặt trời để chuyển hóa cacbônic và nước thành chất dinh dưỡng hữu cơ."
          },
          {
            id: "TN5_7",
            type: "mc",
            ...
            options: ["A. Hồ Chí Minh City","B. Hà Nội","C. Đà Nẵng","D. Huế"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Song invaders","B. Yuan invaders","C. Qing invaders","D. Ming invaders"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Đầu xuân năm Kỷ Dậu 1789, người anh hùng áo vải Quang Trung - Nguyễn Huệ chỉ huy quân Tây Sơn đánh tan 29 vạn quân Thanh (Qing) xâm lược."
          },
          {
            id: "TN5_9",
            type: "mc",
            ...
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Thủ đô của Nhật Bản là Tokyo, một trong những siêu đô thị hiện đại hàng đầu thế giới."
          },
          {
            id: "TN5_10",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 10. Which historical French colonial palace built on the slope of Lớn Mountain in Vũng Tàu was used as a retreat for French governors and once kept Emperor Thành Thái under house arrest?",
            options: ["A. Bạch Dinh (Villa Blanche)","B. Dinh Thống Nhất","C. Bảo tàng Vũng Tàu","D. Biệt thự Hằng Nga"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Bạch Dinh (Villa Blanche) là dinh thự kiến trúc Pháp nổi tiếng ở sườn núi Lớn, từng là nơi giam lỏng vua Thành Thái từ 1907 đến 1916."
          },
          {
            id: "TN5_11",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 11. What type of climate covers the majority of Vietnam's territory?",
            options: ["A. Tropical monsoon climate","B. Temperate climate","C. Polar climate","D. Arid desert climate"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Việt Nam nằm hoàn toàn trong vùng nội chí tuyến Bắc bán cầu, có khí hậu nhiệt đới gió mùa (Tropical monsoon climate) ẩm ướt."
          },
          {
            id: "TN5_12",
            type: "mc",
          ...
          },
          {
            ...
            maxPoints: 2.0,
            text: "Question 13. Choose the word that does not belong with the other ones:",
            options: ["A. car","B. bus","C. train","D. aircraft"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. 9 hours","B. 10 hours","C. 8 hours","D. 11 hours"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. 7.5 cm2","B. 15 cm2","C. 9 cm2","D. 18 cm2"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Công cụ bằng kim loại dùng để mở ổ khóa.","B. Phương tiện giao thông dùng để đi lại.","C. Phương thức, mấu chốt quan trọng để giải quyết vấn đề.","D. Dụng cụ treo tranh ảnh trong lớp học."],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Lặp từ ngữ","B. Thay thế từ ngữ","C. Dùng từ ngữ nối","D. Trái nghĩa"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Sống bao dung, biết bỏ qua lỗi lầm của người khác.","B. Sống tiết kiệm, không lãng phí tiền bạc.","C. Sống dũng cảm vượt qua thử thách.","D. Sống trung thực, không nói dối."],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
        ...
        questions: [
          {
            ...
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Chất rắn (Solid) có lực liên kết phân tử mạnh nên có cả hình dạng và thể tích xác định."
          },
          {
            id: "TN6_2",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 2. An animal that only eats other animals for food is called ______.",
            options: ["A. a herbivore","B. a carnivore","C. an omnivore","D. a producer"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Động vật ăn thịt (carnivore) chỉ săn bắt và ăn các loài động vật khác. Herbivore là ăn thực vật, omnivore là ăn tạp."
          },
          {
            id: "TN6_3",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 3. What is the boiling point of pure water at standard sea-level atmospheric pressure?",
            options: ["A. 0°C","B. 50°C","C. 100°C","D. 120°C"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Nhiệt độ sôi của nước tinh khiết ở áp suất khí quyển tiêu chuẩn là 100 độ C (100°C)."
          },
          {
            id: "TN6_4",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 4. What conditions are necessary for most seeds to germinate?",
            options: ["A. Soil, fertilizer, sunlight","B. Water, oxygen, appropriate temperature","C. Carbon dioxide, water, wind","D. Ice, salt, shadow"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Để nảy mầm (germinate), hầu hết các hạt giống cần nước (độ ẩm), ôxy (để hô hấp) và nhiệt độ thích hợp (warmth)."
          },
          {
            id: "TN6_5",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 5. Which gas do humans and animals inhale from the air for respiration?",
            options: ["A. Carbon dioxide","B. Oxygen","C. Nitrogen","D. Helium"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Con người và động vật hít vào khí ôxy (Oxygen) để thực hiện quá trình trao đổi chất và hô hấp tế bào."
          },
          {
            id: "TN6_6",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 6. Which muscular organ in the human body is responsible for pumping blood through the circulatory system?",
            options: ["A. Lungs","B. Brain","C. Heart","D. Stomach"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Tim (Heart) là cơ quan cơ bắp co bóp liên tục để bơm máu đi nuôi khắp cơ thể thông qua hệ tuần hoàn."
          },
          {
            id: "TN6_7",
            type: "mc",
            ...
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Ngày 2/9/1945, tại Quảng trường Ba Đình (Hà Nội), Bác Hồ đọc Tuyên ngôn Độc lập khai sinh nước Việt Nam Dân chủ Cộng hòa."
          },
          {
            id: "TN6_8",
            type: "mc",
            ...
            options: ["A. Fansipan Mountain","B. Tây Côn Lĩnh Mountain","C. Bà Đen Mountain","D. Bạch Mã Mountain"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Núi Phan Xi Păng (Fansipan) cao 3,143m thuộc dãy Hoàng Liên Sơn là ngọn núi cao nhất Việt Nam và toàn Đông Dương."
          },
          {
            id: "TN6_9",
            type: "mc",
            ...
            options: ["A. New York City","B. Washington, D.C.","C. Los Angeles","D. Chicago"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Thủ đô của Hoa Kỳ là Washington, D.C. (District of Columbia), nơi đặt các cơ quan đầu não chính phủ."
          },
          {
            id: "TN6_10",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 10. Which historical prison located in Côn Đảo district of Bà Rịa - Vũng Tàu province is famous for its brutal 'tiger cages' (chuồng cọp) built by French colonists and later used by US forces?",
            options: ["A. Hỏa Lò Prison","B. Côn Đảo Prison","C. Phú Quốc Prison","D. Sơn La Prison"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Nhà tù Côn Đảo là di tích lịch sử quốc gia đặc biệt, nơi thực dân Pháp và đế quốc Mỹ giam cầm dã man các nhà cách mạng Việt Nam."
          },
          {
            id: "TN6_11",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 11. Which is the largest island of Vietnam, famous for fish sauce, black pepper, and eco-tourism?",
            options: ["A. Cát Bà Island","B. Côn Sơn Island","C. Lý Sơn Island","D. Phú Quốc Island"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
            explanation: "Đảo Phú Quốc (Kiên Giang) là đảo lớn nhất nước ta, được mệnh danh là Đảo Ngọc."
          },
          {
            id: "TN6_12",
            type: "mc",
            ...
            options: ["A. cook","B. cooking","C. to cook","D. cooks"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            maxPoints: 2.0,
            text: "Question 13. Choose the word that does not belong with the other ones:",
            options: ["A. classroom","B. library","C. schoolyard","D. supermarket"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. 1000","B. 2500","C. 5000","D. 2400"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. 135","B. 100","C. 108","D. 90"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. 150 m","B. 100 m","C. 50 m","D. 200 m"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. Chăm chỉ","B. Siêng năng","C. Lười biếng","D. Chịu khó"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. Mặt trời","B. mọc","C. sương mù","D. dần tan biến"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. Ẩn dụ chuyển đổi cảm giác","B. So sánh","C. Nhân hóa","D. Hoán dụ"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
        ...
        questions: [
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 1. Which state of matter has an indefinite shape and an indefinite volume?",
            options: ["A. Solid","B. Liquid","C. Gas","D. Frozen"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Chất khí (Gas) không có hình dạng cũng không có thể tích xác định; nó nở ra để lấp đầy bình chứa."
          },
          {
            id: "TN7_2",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 2. Which part of the plant is primarily responsible for absorbing carbon dioxide and carrying out photosynthesis?",
            options: ["A. Roots","B. Flowers","C. Leaves","D. Stem"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Lá cây (Leaves) chứa nhiều diệp lục, là nơi thực hiện chính của quá trình quang hợp hấp thụ CO2 từ không khí."
          },
          {
            id: "TN7_3",
            type: "mc",
            ...
            options: ["A. Because rubber and plastic are good conductors of electricity.","B. Because rubber and plastic make the plugs heavy.","C. Because rubber and plastic are good insulators.","D. Because rubber and plastic conduct heat quickly."],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Nhựa và cao su là chất cách điện tốt (insulators), giúp bảo vệ người sử dụng không bị giật điện khi cắm/rút phích cắm."
          },
          {
            id: "TN7_4",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 4. A mixture of iron filings (mạt sắt) and sand can be separated easily by using ______.",
            options: ["A. a magnet","B. filter paper","C. water","D. heat"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Sắt có từ tính nên bị nam châm hút. Dùng nam châm (magnet) sẽ hút sạch mạt sắt ra khỏi hỗn hợp cát."
          },
          {
            id: "TN7_5",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 5. What part of the plant absorbs water and minerals from the soil?",
            options: ["A. Leaves","B. Stem","C. Roots","D. Flowers"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Rễ cây (Roots) mọc đâm sâu vào đất có chức năng hút nước và các chất muối khoáng hòa tan nuôi cây."
          },
          {
            id: "TN7_6",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 6. What is the solid state of water?",
            options: ["A. Ice","B. Steam","C. Rain","D. Dew"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Nước đóng băng ở 0°C tạo thành đá (Ice) là trạng thái rắn của nước."
          },
          {
            id: "TN7_7",
            type: "mc",
            ...
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Chiến thắng lịch sử Điện Biên Phủ chấn động địa cầu diễn ra vào ngày 7/5/1954, kết thúc kháng chiến chống thực dân Pháp."
          },
          {
            id: "TN7_8",
            type: "mc",
            ...
            options: ["A. Thiên Đường Cave","B. Sơn Đoòng Cave","C. Phong Nha Cave","D. Sung Sốt Cave"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Hang Sơn Đoòng (Quảng Bình) được công nhận là hang động tự nhiên lớn nhất thế giới, chứa được cả một khối nhà chọc trời."
          },
          {
            id: "TN7_9",
            type: "mc",
            ...
            options: ["A. London","B. Paris","C. New York","D. Edinburgh"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Thủ đô của Vương quốc Anh (United Kingdom) là London, nằm bên sông Thames thơ mộng."
          },
          {
            id: "TN7_10",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 10. Which famous eco-tourism site in Xuyên Mộc district, Bà Rịa - Vũng Tàu province is famous for its natural hot springs, mud baths, and wellness resorts?",
            options: ["A. Bình Châu Hot Springs","B. Đạm Ri Waterfall","C. Suối Tiên Tourist Area","D. Madagui Forest Resort"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Suối khoáng nóng Bình Châu (Xuyên Mộc, BR-VT) nổi tiếng với mạch nước khoáng nóng tự nhiên chảy giữa rừng nguyên sinh."
          },
          {
            id: "TN7_11",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 11. What is the largest landlocked lake (biển hồ) on Earth by surface area?",
            options: ["A. Lake Superior","B. Caspian Sea","C. Baikal Lake","D. Victoria Lake"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Biển Caspi (Caspian Sea) là hồ nước lớn nhất thế giới xét theo diện tích bề mặt (khoảng 371,000 km2)."
          },
          {
            id: "TN7_12",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 12. Choose the correct verb form: They _______ English at this center since 2020.",
            options: ["A. learn","B. learned","C. have been learning","D. are learning"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Dấu hiệu 'since 2020' chỉ hành động bắt đầu trong quá khứ kéo dài đến hiện tại, ta dùng thì hiện tại hoàn thành tiếp diễn 'have been learning'."
          },
          {
            id: "TN7_13",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 13. Choose the word that does not belong with the other ones:",
            options: ["A. crocodile","B. turtle","C. lizard","D. dolphin"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
            explanation: "Crocodile (cá sấu), turtle (rùa), lizard (thằn lằn) đều thuộc lớp bò sát (reptiles), trong khi dolphin (cá heo) thuộc lớp thú/động vật có vú (mammals)."
          },
          {
            id: "TN7_14",
            type: "mc",
          ...
          },
          {
            ...
            options: ["A. 8 years","B. 10 years","C. 9 years","D. 7 years"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
          ...
          },
          {
            ...
            options: ["A. 8 cm2","B. 9 cm2","C. 10 cm2","D. 11 cm2"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 18. Chọn cặp quan hệ từ thích hợp điền vào chỗ trống: '_______ trời mưa to _______ đường phố ngập nước.'",
            options: ["A. Vì... nên...","B. Tuy... nhưng...","C. Mặc dù... nhưng...","D. Nhờ... mà..."],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Cặp quan hệ từ 'Vì... nên...' biểu thị mối quan hệ nguyên nhân - kết quả hợp lý nhất trong câu này."
          },
          {
            id: "TN7_19",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 19. Trong câu: 'Lũ trẻ rất hào hứng khi được đi câu cá. Chuyến đi mang lại nhiều niềm vui cho chúng.', hai câu được liên kết với nhau bằng cách nào?",
            options: ["A. Lặp từ ngữ","B. Dùng từ ngữ nối","C. Thay thế từ ngữ","D. Đồng nghĩa"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Đại từ 'chúng' ở câu thứ hai được dùng để thay thế cho cụm từ 'Lũ trẻ' ở câu thứ nhất nhằm liên kết câu."
          },
          {
            id: "TN7_20",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 20. Đoạn văn miêu tả cảnh: 'Những đóa hoa nở rộ, chúng mỉm cười đón ánh nắng bình minh' sử dụng biện pháp tu từ nghệ thuật nào?",
            options: ["A. So sánh","B. Nhân hóa","C. Ẩn dụ","D. Điệp ngữ"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Hành động 'mỉm cười' của con người được gán cho 'những đóa hoa', đây là biện pháp nghệ thuật nhân hóa."
          }
        ]
      }
    ]
        ...
        questions: [
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 1. Which state of matter expands and spreads out to completely fill any container it is put into?",
            options: ["A. Solid","B. Liquid","C. Gas","D. Frozen"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Chất khí (Gas) có khoảng cách phân tử lớn nên có tính bành trướng, lấp đầy mọi khoảng trống của bình chứa."
          },
          {
            id: "TN8_2",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 2. What three factors do green plants need to carry out photosynthesis?",
            options: ["A. Soil, insects, wind","B. Sunlight, carbon dioxide, water","C. Oxygen, sugar, darkness","D. Fertilizer, salt, shadow"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Thực vật cần ánh sáng mặt trời (sunlight), khí cacbônic (carbon dioxide) và nước (water) để tạo ra chất hữu cơ trong quang hợp."
          },
          {
            id: "TN8_3",
            type: "mc",
            ...
            options: ["A. Iron","B. Aluminium","C. Copper","D. Lead"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Nhôm (Aluminium) và các hợp kim của nó nhẹ, bền và chống ăn mòn tốt nên rất lý tưởng cho chế tạo thân vỏ máy bay."
          },
          {
            id: "TN8_4",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 4. What is the process in which a liquid state of matter turns into a gaseous state?",
            options: ["A. Condensation","B. Freezing","C. Evaporation","D. Melting"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Sự bốc hơi (Evaporation) là hiện tượng chất lỏng chuyển hóa thành thể khí (hơi) ở bề mặt chất lỏng."
          },
          {
            id: "TN8_5",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 5. Which of the following materials is a good conductor of heat?",
            options: ["A. Wood","B. Copper","C. Plastic","D. Glass"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Đồng (Copper) là kim loại dẫn nhiệt rất tốt, tốt hơn nhiều so với gỗ, nhựa và thủy tinh."
          },
          {
            id: "TN8_6",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 6. Which of the following animals is an amphibian (động vật lưỡng cư)?",
            options: ["A. Frog","B. Crocodile","C. Shark","D. Whale"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Ếch (Frog) thuộc lớp lưỡng cư (amphibian) vì chúng có thể sống cả trên cạn và dưới nước."
          },
          {
            id: "TN8_7",
            type: "mc",
            ...
            options: ["A. Lý Thái Tổ","B. Đinh Tiên Hoàng","C. Lê Đại Hành","D. Trần Nhân Tông"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Năm 1010, vua Lý Thái Tổ (Lý Công Uẩn) viết Chiếu dời đô quyết định chuyển đô từ vùng núi Hoa Lư về Đại La và đổi tên là Thăng Long."
          },
          {
            id: "TN8_8",
            type: "mc",
            ...
            options: ["A. Cam Ranh Bay","B. Hạ Long Bay","C. Nha Trang Bay","D. Lăng Cô Bay"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Vịnh Hạ Long (Quảng Ninh) nổi tiếng với hàng nghìn đảo đá vôi kỳ vĩ được UNESCO vinh danh là Di sản Thiên nhiên Thế giới."
          },
          {
            id: "TN8_9",
            type: "mc",
            ...
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Thủ đô của Australia là Canberra, được quy hoạch bài bản nằm giữa hai thành phố lớn tranh chấp là Sydney và Melbourne."
          },
          {
            id: "TN8_10",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 10. Which island district of Bà Rịa - Vũng Tàu province is famous for its National Park, which is a key nesting ground for green sea turtles (vích) in Vietnam?",
            options: ["A. Phú Quốc","B. Lý Sơn","C. Côn Đảo","D. Bạch Long Vĩ"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Quần đảo Côn Đảo là nơi bảo tồn rùa biển (vích) lớn nhất Việt Nam. Hàng năm có hàng ngàn rùa con được thả về đại dương."
          },
          {
            id: "TN8_11",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 11. What is the highest uninterrupted waterfall in the world, located in Venezuela?",
            options: ["A. Angel Falls","B. Niagara Falls","C. Victoria Falls","D. Bản Giốc Falls"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Thác Angel (Venezuela) là thác nước cao nhất thế giới với độ cao đổ dốc liên tục lên tới 979 m."
          },
          {
            id: "TN8_12",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 12. Choose the correct option to fill: If she studies hard, she _______ pass the final examination.",
            options: ["A. would","B. will","C. does","D. has"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Mệnh đề If ở hiện tại đơn (studies), mệnh đề chính dùng 'will + V-inf' (câu điều kiện loại 1 chỉ khả năng có thể xảy ra)."
          },
          {
            id: "TN8_13",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 13. Choose the word that does not belong with the other ones:",
            options: ["A. spring","B. summer","C. autumn","D. weather"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
            explanation: "Spring (mùa xuân), summer (mùa hè), autumn (mùa thu) đều là danh từ chỉ các mùa trong năm, trong khi weather (thời tiết) là khái niệm chung."
          },
          {
            id: "TN8_14",
            type: "mc",
          ...
          },
          {
            ...
            options: ["A. 11","B. 12","C. 10","D. 5"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Trường hợp xấu nhất: Ta bốc toàn bộ bóng đỏ (6 quả) và bóng vàng (4 quả) trước khi bốc được quả bóng xanh đầu tiên. Tổng số bóng bốc phải là: 6 + 4 + 1 = 11 quả. Để CHẮC CHẮN có bóng xanh, ta bốc ít nhất 11 quả. Nhưng đề có phương án 11. Hãy tính: 6 đỏ + 4 vàng = 10 quả không phải xanh. Bốc thêm 1 quả nữa (quả thứ 11) chắc chắn là xanh. Vậy đáp án là 11 quả. Ô, để xem: phương án A là 11."
          },
          {
            id: "TN8_17",
            ...
            options: ["A. 48 cm","B. 50 cm","C. 52 cm","D. 54 cm"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 18. Từ nào dưới đây đồng nghĩa với từ 'dũng cảm'?",
            options: ["A. Gan dạ","B. Hèn nhát","C. Nhút nhát","D. Lười biếng"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Gan dạ (không sợ nguy hiểm, dám đương đầu) đồng nghĩa với từ dũng cảm."
          },
          {
            id: "TN8_19",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 19. Trong đoạn văn: 'Cánh diều bay cao tít trên bầu trời. Cánh diều ấy gửi gắm những ước mơ tuổi thơ.', hai câu liên kết với nhau bằng cách nào?",
            options: ["A. Lặp từ ngữ","B. Thay thế từ ngữ","C. Dùng từ ngữ nối","D. Trái nghĩa"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Cụm từ 'Cánh diều' ở câu thứ nhất được lặp lại ở câu thứ hai để thực hiện phép lặp từ ngữ."
          },
          {
            id: "TN8_20",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 20. Câu tục ngữ: 'Gần mực thì đen, gần đèn thì rạng' khuyên chúng ta nên sống thế nào?",
            options: ["A. Tránh sử dụng mực viết màu đen.","B. Chọn môi trường tốt và bạn bè tốt để học tập và rèn luyện.","C. Thắp nhiều đèn để việc học tập thuận lợi hơn.","D. Hạn chế học tập ở những nơi thiếu ánh sáng."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Mực đại diện cho cái xấu, đèn đại diện cho cái tốt. Câu tục ngữ nhắc nhở ta chọn bạn và chọn môi trường lành mạnh để hoàn thiện bản thân."
          }
        ]
      }
    ]
        ...
        questions: [
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 1. Heat naturally transfers from one object to another. What is the direction of this heat transfer?",
            options: ["A. From a colder object to a hotter object.","B. From a hotter object to a colder object.","C. From a lighter object to a heavier object.","D. From a heavier object to a lighter object."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Nhiệt lượng luôn truyền tự phát từ vật có nhiệt độ cao hơn (hotter) sang vật có nhiệt độ thấp hơn (colder)."
          },
          {
            id: "TN9_2",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 2. What is the main source of energy that green plants absorb to convert carbon dioxide and water into glucose?",
            options: ["A. Wind energy","B. Geothermal energy","C. Sunlight","D. Chemical energy"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Ánh sáng mặt trời (Sunlight) cung cấp năng lượng ánh sáng cần thiết cho phản ứng quang hợp của lục lạp cây xanh."
          },
          {
            id: "TN9_3",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 3. What material is commonly used to make mirrors because it has a smooth surface and reflects light very well?",
            options: ["A. Wood","B. Glass coated with metal","C. Plastic","D. Stone"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Gương thường làm bằng thủy tinh phẳng (Glass) được tráng một lớp kim loại mỏng (bạc hoặc nhôm) phản xạ ánh sáng tốt."
          },
          {
            id: "TN9_4",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 4. What is the main cause of acid rain?",
            options: ["A. High humidity in the forest.","B. Air pollution caused by burning fossil fuels.","C. Excessive use of water in agriculture.","D. Soil erosion on high mountains."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Khói khí thải từ nhà máy chứa khí lưu huỳnh đioxit và nitơ oxit hòa tan vào nước mưa tạo thành axit gây ra mưa axit."
          },
          {
            id: "TN9_5",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 5. Which of the following creatures is a mammal (động vật có vú) despite living in the ocean?",
            options: ["A. Dolphin","B. Shark","C. Salmon","D. Goldfish"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Cá heo (Dolphin) là động vật có vú đẻ con và nuôi con bằng sữa mẹ, không phải cá (hít thở bằng phổi, không phải bằng mang)."
          },
          {
            id: "TN9_6",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 6. What gas do plants release during photosynthesis?",
            options: ["A. Carbon dioxide","B. Oxygen","C. Nitrogen","D. Methane"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Quang hợp của thực vật tiêu thụ khí CO2 và thải ra khí ôxy (Oxygen) sạch vào môi trường."
          },
          {
            id: "TN9_7",
            type: "mc",
            ...
            options: ["A. Lê Lợi","B. Đinh Bộ Lĩnh","C. Trần Hưng Đạo","D. Quang Trung"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Lê Lợi chỉ huy khởi nghĩa Lam Sơn thắng lợi, đánh tan quân Minh xâm lược năm 1427 và lên ngôi hoàng đế sáng lập nhà Hậu Lê."
          },
          {
            id: "TN9_8",
            type: "mc",
            ...
            options: ["A. Đèo Ngang","B. Hải Vân Pass","C. Đèo Cả","D. Đèo Prenn"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Đèo Hải Vân (Hải Vân Pass) là con đèo hùng vĩ, ranh giới tự nhiên giữa Thừa Thiên Huế và Đà Nẵng, nổi tiếng với cảnh đẹp kỳ vĩ."
          },
          {
            id: "TN9_9",
            type: "mc",
            ...
            options: ["A. Shanghai","B. Beijing","C. Guangzhou","D. Hong Kong"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Thủ đô của nước Cộng hòa Nhân dân Trung Hoa là Bắc Kinh (Beijing), trung tâm hành chính lâu đời."
          },
          {
            id: "TN9_10",
            type: "mc",
            ...
            options: ["A. Mũi Nghinh Phong","B. Mũi Né","C. Mũi Điện","D. Mũi Dinh"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Mũi Nghinh Phong (đón gió) là mũi đất vươn dài ra biển ở phía nam thành phố Vũng Tàu, nổi tiếng với chiếc cổng đá hướng biển có tên 'Cổng Trời'."
          },
          {
            id: "TN9_11",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 11. Which is the deepest ocean on Planet Earth?",
            options: ["A. Atlantic Ocean","B. Indian Ocean","C. Arctic Ocean","D. Pacific Ocean"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
            explanation: "Thái Bình Dương (Pacific Ocean) là đại dương lớn nhất và sâu nhất thế giới, chứa Rãnh Mariana sâu hơn 11,000 m."
          },
          {
            id: "TN9_12",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 12. Choose the correct preposition to fill: Mr. David has been teaching English here _______ 5 years.",
            options: ["A. since","B. for","C. in","D. during"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Dùng giới từ 'for' đi kèm với một khoảng thời gian (5 years) trong thì hiện tại hoàn thành."
          },
          {
            id: "TN9_13",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 13. Choose the word that does not belong with the other ones:",
            options: ["A. run","B. jump","C. swim","D. sleep"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
            explanation: "Run (chạy), jump (nhảy), swim (bơi) đều là các động từ chỉ hoạt động thể chất tích cực, còn sleep (ngủ) chỉ trạng thái nghỉ ngơi, thụ động."
          },
          {
            id: "TN9_14",
            type: "mc",
          ...
          },
          {
            ...
            options: ["A. n * n + 4","B. n * n + 1","C. 2 * n + 3","D. 3 * n + 2"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            options: ["A. 80 cm","B. 160 cm","C. 180 cm","D. 72 cm"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 18. Xác định đại từ trong câu: 'Lan học rất giỏi, ai cũng yêu quý bạn ấy.'",
            options: ["A. Lan","B. giỏi","C. ai","D. bạn ấy"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Từ 'ai' là đại từ nghi vấn/bất định dùng để trỏ người nói chung, còn 'bạn ấy' là đại từ xưng hô chỉ ngôi thứ ba."
          },
          {
            id: "TN9_19",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 19. Trong câu: 'Lũ trẻ thích chơi thả diều. Thả diều giúp chúng giải tỏa căng thẳng sau giờ học.', hai câu liên kết với nhau bằng cách nào?",
            options: ["A. Dùng từ ngữ nối","B. Thay thế từ ngữ","C. Lặp từ ngữ","D. Dùng từ đồng nghĩa"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Cụm từ 'Thả diều' ở câu thứ nhất được lặp lại ở câu thứ hai để liên kết hai câu với nhau (phép lặp từ ngữ)."
          },
          {
            id: "TN9_20",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 20. Câu tục ngữ: 'Gần mực thì đen, gần đèn thì rạng' khuyên dạy chúng ta bài học gì?",
            options: ["A. Tránh tiếp xúc với mực đen khi viết bài.","B. Hãy chọn môi trường sống tốt và những người bạn tốt vì họ sẽ ảnh hưởng tích cực đến nhân cách của chúng ta.","C. Nên sử dụng đèn sáng khi học tập.","D. Nêu lên các cách chế tạo mực viết thời xưa."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "'Mực' tượng trưng cho cái xấu, 'đèn' tượng trưng cho cái tốt, sáng sủa. Câu tục ngữ khuyên ta nên chọn bạn và chọn môi trường học tập, sinh sống lành mạch."
          }
        ]
      }
    ]
        ...
        questions: [
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 1. What state of matter has an indefinite volume and an indefinite shape?",
            options: ["A. Solid","B. Liquid","C. Gas","D. Crystal"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Chất khí (Gas) có khoảng cách phân tử rất lớn nên hình dạng và thể tích hoàn toàn phụ thuộc vào vật chứa."
          },
          {
            id: "TN10_2",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 2. An animal that only eats plants and leaves for food is called ______.",
            options: ["A. a predator","B. a prey","C. a herbivore","D. a carnivore"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Động vật ăn cỏ (herbivore) chỉ tiêu thụ thực vật, hoa quả làm nguồn thức ăn chính. Carnivore là ăn thịt."
          },
          {
            id: "TN10_3",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 3. What material is commonly used for making cooking frying pans because it is a very good conductor of heat?",
            options: ["A. Metal (like aluminium or iron)","B. Wood","C. Plastic","D. Rubber"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Kim loại (như nhôm, sắt, đồng) dẫn nhiệt tốt nên giúp thức ăn mau chín đều. Gỗ, nhựa, cao su dùng làm tay cầm để tránh bỏng."
          },
          {
            id: "TN10_4",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 4. What force occurs when two surfaces slide or rub against each other, acting to slow down the motion?",
            options: ["A. Gravity","B. Friction","C. Magnetism","D. Elastic force"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Lực ma sát (Friction) cản trở chuyển động của vật khi hai bề mặt tiếp xúc trực tiếp trượt lên nhau."
          },
          {
            id: "TN10_5",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 5. Which of the following is a renewable source of energy?",
            options: ["A. Coal","B. Petroleum","C. Solar energy","D. Natural gas"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Năng lượng mặt trời (Solar energy) là nguồn năng lượng tái tạo dồi dào, vô tận và thân thiện với môi trường."
          },
          {
            id: "TN10_6",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 6. Which organ in the human body is responsible for mechanical and chemical digestion of food?",
            options: ["A. Lungs","B. Stomach","C. Heart","D. Brain"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Dạ dày (Stomach) co bóp (tiêu hóa cơ học) và tiết dịch vị axit (tiêu hóa hóa học) để nghiền nát thức ăn."
          },
          {
            id: "TN10_7",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 7. The Lam Sơn uprising against the Ming invaders was led by which leader?",
            options: ["A. Lê Lợi","B. Nguyễn Trãi","C. Ngô Quyền","D. Trần Hưng Đạo"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Cuộc khởi nghĩa Lam Sơn lừng lẫy giải phóng đất nước khỏi ách đô hộ của nhà Minh do Bình Định Vương Lê Lợi khởi xướng."
          },
          {
            id: "TN10_8",
            type: "mc",
            ...
            options: ["A. Cát Tiên National Park","B. Cúc Phương National Park","C. Phong Nha-Kẻ Bàng Park","D. Ba Bể National Park"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Vườn quốc gia Cúc Phương (Ninh Bình, Thanh Hóa, Hòa Bình) thành lập năm 1962 là vườn quốc gia đầu tiên và cổ nhất của nước ta."
          },
          {
            id: "TN10_9",
            type: "mc",
            ...
            options: ["A. Munich","B. Berlin","C. Frankfurt","D. Paris"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Thủ đô của nước Cộng hòa Liên bang Đức là Berlin, nổi tiếng với lịch sử lâu đời và các công trình di sản phục hưng."
          },
          {
            id: "TN10_10",
            type: "mc",
            ...
            options: ["A. Nhà Lớn Long Sơn","B. Chùa Đại Tòng Lâm","C. Thích Ca Phật Đài","D. Niết Bàn Tịnh Xá"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Nhà Lớn Long Sơn (đền Ông Trần) là di tích lịch sử - văn hóa nghệ thuật độc đáo tọa lạc trên đảo Long Sơn, thể hiện nét văn hóa tâm linh Nam Bộ cổ xưa."
          },
          {
            id: "TN10_11",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 11. What is the capital city of Canada?",
            options: ["A. Toronto","B. Vancouver","C. Ottawa","D. Montreal"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Thủ đô của Canada là Ottawa, được chọn làm thủ đô bởi Nữ hoàng Victoria vào năm 1857."
          },
          {
            id: "TN10_12",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 12. Choose the correct option: She is the _______ girl in her class.",
            options: ["A. tallest","B. taller","C. tall","D. more tall"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
            explanation: "Cấu trúc so sánh nhất đối với tính từ ngắn (tall): 'the + adj-est'. Do đó ta chọn 'tallest'."
          },
          {
            id: "TN10_13",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 13. Choose the word that does not belong with the other ones:",
            options: ["A. dictionary","B. notebook","C. textbook","D. television"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
            explanation: "Dictionary (từ điển), notebook (vở ghi), textbook (sách giáo khoa) đều là đồ dùng học tập bằng giấy, còn television (ti vi) là thiết bị điện tử gia dụng."
          },
          {
            id: "TN10_14",
            type: "mc",
            ...
            options: ["A. 1:30 PM","B. 2:00 PM","C. 2:30 PM","D. 3:00 PM"],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
          ...
          },
          {
            ...
            options: ["A. 2.5 kg","B. 3 kg","C. 4 kg","D. 5 kg"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
          ...
          },
          {
            ...
            options: ["A. Hexagon","B. Heptagon","C. Octagon","D. Oval"],
            modelAnswer: "A",
            rubric: "Chọn đúng A.",
          ...
          },
          {
            ...
            type: "mc",
            maxPoints: 2.0,
            text: "Question 18. Xác định bộ phận vị ngữ trong câu ghép sau ở vế thứ hai: 'Trăng đã lên cao, biển cả mênh mông lấp lánh.'",
            options: ["A. Trăng đã lên cao","B. biển cả","C. mênh mông lấp lánh","D. lấp lánh"],
            modelAnswer: "C",
            rubric: "Chọn đúng C.",
            explanation: "Vế thứ hai là 'biển cả mênh mông lấp lánh'. Chủ ngữ là 'biển cả'. Vị ngữ trả lời cho câu hỏi 'thế nào?' là 'mênh mông lấp lánh'."
          },
          {
            id: "TN10_19",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 19. Xác định từ viết sai chính tả trong câu sau: 'Mùa thu mới chớm nhưng nước đã trong vắt.'?",
            options: ["A. chớm","B. nước","C. trong","D. vắt (không có từ viết sai)"],
            modelAnswer: "D",
            rubric: "Chọn đúng D.",
            explanation: "Tất cả các từ trong câu đều được viết đúng chính tả tiếng Việt."
          },
          {
            id: "TN10_20",
            type: "mc",
            maxPoints: 2.0,
            text: "Question 20. Biện pháp tu từ điệp từ trong đoạn thơ: 'Đoàn thuyền đánh cá lại ra khơi / Câu hát căng buồm cùng gió khơi' có tác dụng nghệ thuật gì?",
            options: ["A. Kéo dài câu thơ ra cho đủ nhịp.","B. Tạo âm hưởng khỏe khoắn, nhấn mạnh tư thế chủ động, tinh thần lạc quan ra khơi lao động hăng say của người ngư dân.","C. Thể hiện sự thiếu hụt từ vựng của nhà thơ.","D. Miêu tả độ rộng lớn của biển khơi."],
            modelAnswer: "B",
            rubric: "Chọn đúng B.",
            explanation: "Phép điệp từ 'khơi' kết hợp nhịp điệu thơ dồn dập khắc họa sinh động cảnh ra khơi trong tiếng hát hào sảng, thể hiện tinh thần làm chủ thiên nhiên, hăng say lao động kiến thiết đất nước."
          }
        ]
      }
    ]
